...
if __name__ == "__main__":
    ...
    for item in big_array:
        ...
        if len(item[0]) == 21:
            spaced_scrambled = ""
            spaced_scrambled = item[0][0:6] + " " + item[0][6:7] + " " + item[0][7:14] + " " + item[0][14:15] + " " + item[0][15:21]
            spaced_solution = ""
            spaced_solution = item[1][0:6] + " " + item[1][6:7] + " " + item[1][7:14] + " " + item[1][14:15] + " " + item[1][15:21]
